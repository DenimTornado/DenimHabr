...
function updateInfo(doc) {
    ...
    //set icon
    document.getElementsByClassName("icon")[0].getElementsByTagName('img')[0].setAttribute("src", "http:"+src);
    ...
    if (diffKarma > 0) {
        document.getElementById("karma").innerHTML = "<span class='diff'>↑</span> ";
    ...
    if (diffRating > 0) {
        document.getElementById("rating").innerHTML = "<span class='diff'>↑</span> ";
    ...
    if (diffRatingPosition < 0) {
        document.getElementById("position").innerHTML = "<span class='diff'>↑</span> ";
